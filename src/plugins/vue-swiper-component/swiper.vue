<template>
    <section class="wh_content" @touchmove="fn">
        ...
        <div v-if="showIndicator" class="wh_indicator">
            <div v-for="(tag,$index) in slidesLength" v-bind:class="{ wh_show_bgcolor: index-1==$index }" class="wh_indicator_item" @click="slideTo($index)">{{$index + 1}}</div>
        </div>

        <div class="arraws" v-if="showIndicator">
            <div class="prevSlide" @click="prevSlide"><img src="../../images/home/arrow-lf.png" alt=""></div>
            <div class="nextSlide" @click="nextSlide"><img src="../../images/home/arrow-rt.png" alt=""></div>
        </div>
    </section>
</template>
